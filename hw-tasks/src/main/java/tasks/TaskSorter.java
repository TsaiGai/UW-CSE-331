...
public class TaskSorter {
    ...
    /**
     * Represents a Graph field with nodes as Task objects and edges as Dependency objects.
     */
    private Graph<Task, Dependency> graph = new Graph<>();
    ...
    public Set<Dependency> getOutgoingDependencies(Task t) {
        ...
        for (Task task : graph.listChildren(t).keySet()) {
            for (Dependency dependency : graph.listChildren(t).get(task)) {
                Dependency depSet = dependency;
